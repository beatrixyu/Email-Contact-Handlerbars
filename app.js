...
// //has to set the dirname /public earlier to define the router
...
// app.set("view engine", "hbs"); //use hbs to be the module engine
// hbs.registerPartials(__dirname + "/views/partial"); //define the path
...
//     //to make a default avatar
//     if (fileName == null) fileName = "homer.png";

//     //to make contact data
//     let contact = {
//       id: Date.now(),
//       name: req.body.name,
